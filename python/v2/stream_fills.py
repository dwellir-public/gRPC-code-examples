#!/usr/bin/env python3
"""
Stream Fills Example - Hyperliquid gRPC API v2
...
Usage:
  ...
  python stream_fills.py --block 12345678         # Stream from specific block height
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Stream fills from Hyperliquid L1 gRPC API (v2)",
...
def main():
    ...
    print("Hyperliquid gRPC - Stream Fills Example (v2 API)")
    print("=================================================")
    ...
    with grpc.secure_channel(endpoint, credentials, options=options) as channel:
        ...
        if args.timestamp:
            ...
            print(f"Starting fills stream from block height {args.block:,}")
