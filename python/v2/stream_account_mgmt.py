#!/usr/bin/env python3
"""
Stream Account Management Example - Hyperliquid gRPC API v2
...
Usage:
  ...
  python stream_account_mgmt.py --block 831000000  # From specific block
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Stream account management events from Hyperliquid L1 gRPC API (v2)",
...
def main():
    ...
    print("Hyperliquid gRPC - Stream Account Management Example (v2 API)")
    print("===============================================================")
