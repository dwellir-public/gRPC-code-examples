#!/usr/bin/env python3
"""
Stream Asset Transfers Example - Hyperliquid gRPC API v2
...
Usage:
  ...
  python stream_transfers.py --block 831000000  # From specific block
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Stream asset transfers from Hyperliquid L1 gRPC API (v2)",
...
def main():
    ...
    print("Hyperliquid gRPC - Stream Asset Transfers Example (v2 API)")
    print("===========================================================")
