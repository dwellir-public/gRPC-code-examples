#!/usr/bin/env python3
"""
Stream Blocks Example - Hyperliquid gRPC API v1
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Stream blocks from Hyperliquid L1 gRPC API (v1)",
...
def main():
    ...
    print("Hyperliquid gRPC - Stream Blocks Example (v1 API)")
    print("==================================================")
    ...
    with grpc.secure_channel(endpoint, credentials, options=options) as channel:
        ...
        # v1 API uses Timestamp with timestamp field
        if args.timestamp:
            ...
            # timestamp=0 targets latest data
