#!/usr/bin/env python3
"""
Stream TWAP Orders Example - Hyperliquid gRPC API v1
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Stream TWAP orders from Hyperliquid L1 gRPC API (v1)",
...
def main():
    ...
    print("Hyperliquid gRPC - Stream TWAP Orders Example (v1 API)")
    print("======================================================")
